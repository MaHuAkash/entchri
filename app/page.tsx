    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-50">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-72 h-72 bg-blue-100 rounded-full mix-blend-multiply filter blur-xl opacity-20"
        />
        <motion.div
          animate={{ 
            x: [0, -100, 0],
          ...
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-cyan-100 rounded-full mix-blend-multiply filter blur-xl opacity-10"
        />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <motion.div
          ...
          className="fixed top-24 right-4 sm:right-8 z-40 bg-white/90 backdrop-blur-sm border border-blue-200 rounded-xl shadow-lg p-3 hidden lg:block"
        >
        ...
        <div className="mb-16 sm:mb-20 relative">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              ...
              <span className="block mt-2">Pay Less!</span>
            </h1>
            ...
            >
              Compare <span className="font-bold text-blue-600">600+ airlines</span> instantly. 
          ...
          >
            ...
            <div className="bg-gradient-to-br from-white to-blue-50 rounded-3xl shadow-2xl border border-blue-100 p-6 sm:p-8 relative overflow-hidden">
              {/* Decorative Elements */}
        ...
        <div className="mb-16">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Fly with the <span className="text-blue-600">Best</span>
            </h2>
                  ...
                  {[
                    ...
                    <div key={index} className="space-y-1">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-bold">{stat.value}% save more</span>
                      </div>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <div className="bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-500 rounded-3xl p-8 text-center shadow-2xl relative overflow-hidden">
            {/* Animated elements */}
            <motion.div
              animate={{ y: [0, -10, 0] }}
